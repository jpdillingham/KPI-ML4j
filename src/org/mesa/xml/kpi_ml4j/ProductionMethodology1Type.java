...
/**
 * <p>Java class for ProductionMethodology1Type complex type.
 * 
...
@XmlType(name = "ProductionMethodology1Type")
@XmlSeeAlso({
    ProductionMethodologyType.class
})
public class ProductionMethodology1Type
    extends CodeType
{
